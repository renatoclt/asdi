...
Public Class frm_mes
    ...
    Private Sub Cargar_datos()
        dg_periodo.DataSource = obj_ln_periodo.List_Periodo_Abierto()
    ...
    Private Sub dg_periodo_CellContentClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dg_periodo.CellContentClick
        Dim i As Integer
    ...
    Private Sub frm_mes_FormClosed(ByVal sender As System.Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles MyBase.FormClosed

    End Sub

    Private Sub chk_regular_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles chk_regular.CheckedChanged
    ...
    Private Sub frm_mes_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Cargar()
        Cargar_datos()
    End Sub
End Class