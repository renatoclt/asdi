...
Public Class frm_matricula_mover
    ...
    Private Sub cbx_curso_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cbx_curso.SelectedIndexChanged
        If (seleccionar_curso) Then
            ...
            'grupos cambio
            If (obj_ln_view_curso_grupo.List_Curso_Grupo_Por_Periodo_Curso_Y_Horario(id_periodo, id_curso, id_horario).Count < 1) Then
                cbx_grupo_origen.Enabled = False
            Else
    ...
    Private Sub btn_Guardar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Guardar.Click
        ...
        Dim Msg As Integer
        Msg = MsgBox("Desea cambiar al alumno(a): " + lchk_grupo_origen.Text + " al grupo destino: " + cbx_grupo_destino.Text + "?", MsgBoxStyle.Question & MsgBoxStyle.YesNo, "Guardar?")
        If (Msg = vbYes) Then
