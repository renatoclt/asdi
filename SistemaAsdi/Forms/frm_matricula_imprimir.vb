Public Class frm_matricula_imprimir
    ...
    Private Sub PrintDocument1_PrintPage(ByVal sender As System.Object, ByVal e As System.Drawing.Printing.PrintPageEventArgs) Handles PrintDocument1.PrintPage
        ...
        If separata_imprimir = 1 Then
            ...
            e.Graphics.DrawString("S/. " + monto, New Font("Calibri", 10, FontStyle.Regular), Brushes.Black, x + 330, y + 40)
            e.Graphics.DrawString("S/. " + monto, New Font("Calibri", 10, FontStyle.Regular), Brushes.Black, x + 330, y + 170)
            e.Graphics.DrawString("S/. " + monto, New Font("Calibri", 10, FontStyle.Regular), Brushes.Black, x + 330, y + 230)
            e.Graphics.DrawString("S/. 0.00", New Font("Calibri", 10, FontStyle.Regular), Brushes.Black, x + 330, y + 190)
        ...
        Else
            ...
            e.Graphics.DrawString(String.Format("{0:C}", Convert.ToDouble(LblImportePagar.Text)), New Font("Calibri", 10, FontStyle.Regular), Brushes.Black, x + 330, y + 40)
            e.Graphics.DrawString(Convert.ToString(String.Format("{0:C}", Convert.ToDouble(TxtMonto.Text))), New Font("Calibri", 10, FontStyle.Regular), Brushes.Black, x + 330, y + 170)
            e.Graphics.DrawString(Convert.ToString(String.Format("{0:C}", Convert.ToDouble(LblImportePagar.Text))), New Font("Calibri", 10, FontStyle.Regular), Brushes.Black, x + 330, y + 230)
            e.Graphics.DrawString(Convert.ToString(String.Format("{0:C}", Convert.ToDouble(TxtDescuento.Text))), New Font("Calibri", 10, FontStyle.Regular), Brushes.Black, x + 330, y + 190)
