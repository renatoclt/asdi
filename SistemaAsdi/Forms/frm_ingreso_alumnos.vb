...
Public Class frm_ingreso_alumnos
    ...
    Public Sub Modificar(ByVal id_persona_ As Integer, ByVal frm As frm_modificar_alumno)
        ...
        cb_ciclo.SelectedValue = obj_n_alumno.Alumno_Ciclo
    End Sub
        ...
        If (esta_agregando) Then
            If ((txt_nombres.Text <> "") And (txt_ap_paterno.Text <> "") And (txt_ap_materno.Text <> "")) Then
                ...
                If (Msg = vbYes) Then
                    ...
                    obj_n_alumno.Alumno_Otro_Ciclo = ingreso_alumnos_otro_curso
                    obj_n_alumno.Alumno_Ciclo_Alt = ingreso_alumnos_ciclo_alt
    ...
    Public Sub Llenar_ciclo()
        obj.Llenar_ciclo_con_planest(cb_ciclo, Convert.ToString(cbx_plan_est.SelectedValue))
    End Sub

    Private Sub cb_ciclo_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cb_ciclo.SelectedIndexChanged
        txt_ciclo.Text = cb_ciclo.SelectedValue
    End Sub

    Private Sub btn_otrociclo_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_otrociclo.Click
        frm_otro_ciclo.ShowDialog()
    End Sub

    Public Sub Otro_curso_opcional(ByVal a As Double, ByVal b As Integer)
        ingreso_alumnos_otro_curso = a
        ingreso_alumnos_ciclo_alt = b
    End Sub
