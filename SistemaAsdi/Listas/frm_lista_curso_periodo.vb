...
Public Class frm_lista_curso_periodo
    ...
    Private Sub cbx_periodo_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cbx_periodo.SelectedIndexChanged
        obj.Llenar_plan_est(cbplan_est, Convert.ToString(cbx_periodo.SelectedValue))
    End Sub
    ...
    Private Sub cbplan_est_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cbplan_est.SelectedIndexChanged
        If (seleccionar_periodo) Then
            id_periodo = cbx_periodo.SelectedValue
            periodo = cbx_periodo.Text

            dg_cursos.DataSource = obj_ln_view_cursos.List_Cursos_Periodo(id_periodo, Convert.ToInt32(cbplan_est.SelectedValue))
