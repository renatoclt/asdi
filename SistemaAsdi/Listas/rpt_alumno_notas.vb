...
Public Class rpt_alumno_notas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SistemaAsdi.rpt_alumno_notas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_alumno_notas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_alumno_notas = New rpt_alumno_notas()
        rpt.Site = Me.Site
        Return rpt
    End Function
