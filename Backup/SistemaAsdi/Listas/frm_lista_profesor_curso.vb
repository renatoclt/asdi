...
Public Class frm_lista_profesor_curso
    ...
    Private Sub frm_lista_profesor_curso_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Cargar()
        Cargar_Datos()
    End Sub
    ...
    Private Sub cbx_periodo_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cbx_periodo.SelectedIndexChanged
        If (seleccionar_periodo) Then
            ...
            cbx_curso.DataSource = obj_ln_curso.List_Curso_Por_Periodo(id_periodo)
            cbx_curso.DisplayMember = "Curso_Nombre"
            cbx_curso.ValueMember = "Curso_Codigo"
            cbx_curso.SelectedItem = Nothing
            If (obj_ln_curso.List_Curso_Por_Periodo(id_periodo).Count = 0) Then
                cbx_curso.Enabled = False
                btn_reporte.Enabled = False
            Else
    ...
    Private Sub cbx_curso_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cbx_curso.SelectedIndexChanged
        If (seleccionar_curso) Then
            ...
            dg_profesores.DataSource = obj_ln_view_profesores.List_Profesores_Por_Periodo_Y_Curso(id_periodo, id_curso)
    ...
    Private Sub btn_reporte_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_reporte.Click
        ...
        rptDoc = New rpt_lista_profesor_curso
    ...
    Private Sub frm_lista_profesor_curso_FormClosed(ByVal sender As System.Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles MyBase.FormClosed
        frm_principal.frm_lista_profesor_curso_activo = False
    End Sub
End Class