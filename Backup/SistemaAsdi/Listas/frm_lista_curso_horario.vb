...
Public Class frm_lista_curso_horario
    ...
    Private Sub frm_lista_curso_horario_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Cargar()
        Cargar_Datos()
    End Sub
    ...
    Private Sub cbx_horario_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cbx_horario.SelectedIndexChanged
        If (seleccionar_horario) Then
            ...
            dg_cursos.DataSource = obj_ln_view_cursos.List_Cursos_Periodo_y_Horario(id_periodo, id_horario)
    ...
    Private Sub btn_reporte_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_reporte.Click
        ...
        rptDoc = New rpt_lista_curso_horario
    ...
    Private Sub frm_lista_curso_horario_FormClosed(ByVal sender As System.Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles MyBase.FormClosed
        frm_principal.frm_lista_curso_horario_activo = False
    End Sub
End Class