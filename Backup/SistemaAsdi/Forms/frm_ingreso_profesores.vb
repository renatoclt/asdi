...
Public Class frm_ingreso_profesores
    ...
    '------ Profesor
    Private obj_n_profesor As cls_n_profesor_ficha
    Private obj_ln_profesor As cls_ln_profesor_ficha
    ...
    Public Sub Modificar(ByVal id_persona_ As Integer, ByVal frm As frm_modificar_profesor)
        frm_modificar_profesor_ = New frm_modificar_profesor
        frm_modificar_profesor_ = frm
        ...
        obj_n_profesor = obj_ln_profesor.Get_Profesor(id_persona_)
        ...
        chk_activo.Checked = obj_n_profesor.Profesor_Estado
    End Sub
    ...
    Private Sub Cargar()
        ...
        obj_n_profesor = New cls_n_profesor_ficha
        obj_ln_profesor = New cls_ln_profesor_ficha
        txt_id_persona.Text = ""
        txt_nombres.Text = ""
        txt_ap_paterno.Text = ""
        txt_ap_materno.Text = ""
    ...
    Private Sub frm_lista_profesores_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Cargar()
        Cargar_datos()
        esta_agregando = True
        esta_editando = False
        ...
        If (esta_agregando) Then
            If ((txt_nombres.Text <> "") And (txt_ap_paterno.Text <> "") And (txt_ap_materno.Text <> "")) Then
                ...
                If (Msg = 6) Then
                    ...
                    obj_n_profesor.Profesor_Persona_Codigo = id_persona
                    obj_n_profesor.Profesor_Estado = estado
                    obj_ln_profesor.Add_Profesor(obj_n_profesor)
                    Me.Close()
                End If
            Else
        ...
        If (esta_editando) Then
            If ((txt_nombres.Text <> "") And (txt_ap_paterno.Text <> "") And (txt_ap_materno.Text <> "")) Then
                ...
                If (Msg = 6) Then
                    ...
                    obj_n_profesor.Profesor_Persona_Codigo = id_persona
                    obj_n_profesor.Profesor_Estado = estado
                    obj_ln_profesor.Update_Profesor(obj_n_profesor)

                    frm_modificar_profesor_.frm_ingreso_profesores_activo = False
                    Me.Close()
                End If
            Else
                MsgBox("Debe llenar la Información requerida (*) ", MsgBoxStyle.Exclamation, "Advertencia!!")
    ...
    Private Sub frm_ingreso_profesores_FormClosed(ByVal sender As System.Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles MyBase.FormClosed
        frm_principal.frm_ingreso_profesores_activo = False
    End Sub
