...
Public Class cls_dt_curso
    ...
    Public Sub Add_Curso(ByVal obj_curso As cls_n_curso)
        ...
        Dim id_programa As New MySqlParameter("?v_id_programa", MySql.Data.MySqlClient.MySqlDbType.Int16)
        id_programa.Value = obj_curso.Curso_Programa
        id_programa.Direction = ParameterDirection.Input
        comando.Parameters.Add(id_programa)
    ...
    Public Function List_Curso() As List(Of cls_n_curso)
        ...
        comando.CommandText = "SELECT c.id_curso, c.curso, p.nombre, c.abreviatura FROM curso c, programa p where p.id_programa = c.id_programa ORDER BY c.id_curso ASC"
        DataReader = comando.ExecuteReader
        While DataReader.Read
            obj_curso = New cls_n_curso
            obj_curso.Curso_Codigo = DataReader(0)
            obj_curso.Curso_Nombre = DataReader(1)
            obj_curso.Curso_Programa = DataReader(2)
            obj_curso.Curso_Abreviatura = DataReader(3)
