...
Public Class cls_dt_view_alumnos
    ...
    Public Function Lista_Alumnos_Por_Profesor(ByVal id_profesor_ficha As Integer, ByVal id_plan_est As Integer) As List(Of cls_n_alumno_reporte)
        ...
        comando.Connection = conn
        comando.CommandType = CommandType.Text
        comando.CommandText = "SELECT id_alumno_ficha, nombre, nombre_grupo, horario FROM view_alumno_profesor WHERE id_profesor_ficha = " + id_profesor_ficha.ToString + " and id_plan_est= " + id_plan_est.ToString
        DataReader = comando.ExecuteReader
        While DataReader.Read
    ...
    Public Function Lista_Alumnos_Por_Horario(ByVal id_horario As Integer, ByVal id_periodo As Integer) As List(Of cls_n_alumno_reporte)
        Dim list_alumnos As New List(Of cls_n_alumno_reporte)
        Dim DataReader As MySqlDataReader
        Dim obj_reporte_alumno As cls_n_alumno_reporte
        conn = objConexion.Open
        comando.Connection = conn
        comando.CommandType = CommandType.Text
        comando.CommandText = "SELECT id_alumno_ficha, nombre, nombre_grupo, curso FROM view_alumno_horario WHERE id_horario = " + id_horario.ToString + " and id_periodo = " + id_periodo.ToString
        DataReader = comando.ExecuteReader
        While DataReader.Read
            obj_reporte_alumno = New cls_n_alumno_reporte
            obj_reporte_alumno.Reporte_Alumno_Codigo = DataReader(0)
