...
Public Class cls_dt_horario
    ...
    Public Sub Add_Horario(ByVal obj_horario As cls_n_horario)
        ...
        Dim id_plan_est As New MySqlParameter("?v_id_plan_est", MySql.Data.MySqlClient.MySqlDbType.Int32)
        id_plan_est.Value = obj_horario.Horario_Id_Plan_Est
    ...
    Public Function List_Horario() As List(Of cls_n_horario)
        ...
        comando.CommandText = "SELECT h.id_horario, h.horario, h.costo, p.plan_estudio FROM horario h, plan_estudio p where h.id_plan_est = p.id_plan_est ORDER BY h.id_horario ASC"
        ...
        While DataReader.Read
            ...
            obj_horario.Horario_Plan_Est = DataReader(3)
