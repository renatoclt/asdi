...
Public Class cls_dt_view_profesores
    ...
    Public Function List_View_Profesores_Por_Periodo(ByVal id_periodo As Integer, ByVal id_plan_est As Integer) As List(Of cls_n_view_profesores)
        ...
        comando.Connection = conn
        comando.CommandType = CommandType.Text
        comando.CommandText = "select vp.id_persona, vp.id_profesor_ficha, vp.nombre, vp.estado from curso_ofertado co, curso_grupo cg, view_profesores vp, plan_estudio ps, curso_plan_est cp, curso c where ps.id_plan_est = cp.id_plan_est and cp.id_curso = c.id_curso and co.id_curso = c.id_curso and co.id_curso_ofertado = cg.id_curso_ofertado and cg.id_profesor_ficha = vp.id_profesor_ficha and co.id_periodo = " + id_periodo.ToString + " and ps.id_plan_est = " + id_plan_est.ToString + " group by vp.nombre "
        DataReader = comando.ExecuteReader
        While DataReader.Read
            obj_view_profesor = New cls_n_view_profesores
            obj_view_profesor.View_Profesores_Codigo_Persona = DataReader(0)
