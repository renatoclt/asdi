...
Public Class cls_dt_view_curso_grupos
    ...
    Public Function List_Curso_Grupo_Por_Periodo_Curso_Y_Horario(ByVal id_periodo As Integer, ByVal id_curso As Integer, ByVal id_horario As Integer) As List(Of cls_n_view_curso_grupos)
        ...
        comando.Connection = conn
        comando.CommandType = CommandType.Text
        comando.CommandText = "select cg.id_curso_grupo, concat(cg.nombre_grupo,_latin1' - ',h.horario) as nombre_grupo from curso_grupo cg, curso_ofertado co, horario h where cg.id_horario = h.id_horario and cg.id_curso_ofertado = co.id_curso_ofertado and co.id_periodo = " + id_periodo.ToString + " and co.id_curso = " + id_curso.ToString + " and cg.id_horario = " + id_horario.ToString
        DataReader = comando.ExecuteReader
        While DataReader.Read
            obj_view_curso_grupo = New cls_n_view_curso_grupos
            obj_view_curso_grupo.View_Curso_Grupo_Codigo = DataReader(0)
    ...
    Public Function List_Curso_Grupo_Por_Periodo_Curso_Horario_Y_Grupo(ByVal id_periodo As Integer, ByVal id_curso As Integer, ByVal id_horario As Integer, ByVal id_curso_grupo As Integer) As List(Of cls_n_view_curso_grupos)
        ...
        comando.Connection = conn
        comando.CommandType = CommandType.Text
        comando.CommandText = "select cg.id_curso_grupo, concat(cg.nombre_grupo,_latin1' - ',h.horario) as nombre_grupo from curso_grupo cg, curso_ofertado co, horario h where cg.id_horario = h.id_horario and cg.id_curso_ofertado = co.id_curso_ofertado and co.id_periodo = " + id_periodo.ToString + " and co.id_curso = " + id_curso.ToString + " and cg.id_curso_grupo <> " + id_curso_grupo.ToString
        DataReader = comando.ExecuteReader
        While DataReader.Read
            obj_view_curso_grupo = New cls_n_view_curso_grupos
            obj_view_curso_grupo.View_Curso_Grupo_Codigo = DataReader(0)
