...
Public Class cls_dt_alumno_ficha
    ...
    Public Sub Add_Alumno(ByVal obj_alumno As cls_n_alumno_ficha)
        ...
        Dim otro_ciclo As New MySqlParameter("?v_otro_ciclo", MySql.Data.MySqlClient.MySqlDbType.Double)
        otro_ciclo.Value = obj_alumno.Alumno_Otro_Ciclo
        otro_ciclo.Direction = ParameterDirection.Input
        comando.Parameters.Add(otro_ciclo)

        Dim ciclo_alt As New MySqlParameter("?v_ciclo_alt", MySql.Data.MySqlClient.MySqlDbType.Int16)
        ciclo_alt.Value = obj_alumno.Alumno_Ciclo_Alt
        ciclo_alt.Direction = ParameterDirection.Input
        comando.Parameters.Add(ciclo_alt)
